 ...
 */
public class AddDefaultConstructorTest extends CorrectiveActionTest{
  
  public AddDefaultConstructorTest(String name) {
    super(name);
  }
  
  public static Test suite() {
    return new TestSuite(AddDefaultConstructorTest.class);
  }
  
  public String getTemplate() {
    return "Audit/corrective/NotSerializableSuperclass/AddDefaultConstructor/" +
  ...
  protected void performSimpleTest() throws Exception {
    super.performSimpleTest(NotSerializableSuperRule.class,
        "refactorit.audit.action.not_serializable_super.add_constructor");
  }
