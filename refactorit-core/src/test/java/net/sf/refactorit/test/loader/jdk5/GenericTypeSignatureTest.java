...
public class GenericTypeSignatureTest extends AbstractRegressionTest {
  ...
  public static Test suite() {
    return new TestSuite(GenericTypeSignatureTest.class);
  }
...
//            GenericTypeSignatureTest.this.dirPath.toFile());
//        // Log errors
...
//    try {
//      ClassFileReader classFileReader = ClassFileReader.read(OUTPUT_DIR
//          + File.separator + "X.class");
//      assertEquals("Wrong signature", "<T:Ljava/lang/Object;>Lp/A<TT;>;",
//          new String(classFileReader.getGenericSignature()));
...
//    }
//
//    IClassFileReader classFileReader = ToolFactory.createDefaultClassFileReader(
//        OUTPUT_DIR + File.separator + "X.class", IClassFileReader.ALL);
//    assertNotNull(classFileReader);
//    IClassFileAttribute classFileAttribute = org.eclipse.jdt.internal.core.util.
//        Util.getAttribute(classFileReader, IAttributeNamesConstants.SIGNATURE);
//    assertNotNull(classFileAttribute);
//    ISignatureAttribute signatureAttribute = (ISignatureAttribute)
//        classFileAttribute;
...
//    classFileAttribute = org.eclipse.jdt.internal.core.util.Util.getAttribute(
//        codeAttribute, IAttributeNamesConstants.LOCAL_VARIABLE_TYPE_TABLE);
//    assertNotNull(classFileAttribute);
//    ILocalVariableTypeTableAttribute localVariableTypeTableAttribute = (
//        ILocalVariableTypeTableAttribute) classFileAttribute;
//    ILocalVariableTypeTableEntry[] entries = localVariableTypeTableAttribute.
...
//    assertNotNull("no signature", signature);
//    assertEquals("Wrong signature", "LX<LX<Ljava/lang/String;>;>;",
//        new String(signature));
//
...
//        codeAttribute, IAttributeNamesConstants.LOCAL_VARIABLE_TYPE_TABLE);
//    assertNotNull(classFileAttribute);
//    localVariableTypeTableAttribute = (ILocalVariableTypeTableAttribute)
//        classFileAttribute;
...
//
//    classFileReader = ToolFactory.createDefaultClassFileReader(OUTPUT_DIR
//        + File.separator + "X.class", IClassFileReader.ALL);
//    assertNotNull(classFileReader);
//    classFileAttribute = org.eclipse.jdt.internal.core.util.Util.getAttribute(
//        classFileReader, IAttributeNamesConstants.SIGNATURE);
//    assertNotNull(classFileAttribute);
...
//    ISignatureAttribute signatureAttribute = (ISignatureAttribute)
//        classFileAttribute;
//    assertEquals("Wrong signature", "Lp/A<Ljava/lang/String;>;",
//        new String(signatureAttribute.getSignature()));
//
//    classFileReader = ToolFactory.createDefaultClassFileReader(OUTPUT_DIR
//        + File.separator + "p/A.class", IClassFileReader.ALL);
//    assertNotNull(classFileReader);
//    classFileAttribute = org.eclipse.jdt.internal.core.util.Util.getAttribute(
//        classFileReader, IAttributeNamesConstants.SIGNATURE);
//    assertNotNull(classFileAttribute);
...
//    char[] signature = signatureAttribute.getSignature();
//    assertNotNull("No signature", signature);
//    assertEquals("Wrong signature", "<P:Ljava/lang/Object;>Ljava/lang/Object;",
//        new String(signature));
//
//    IMethodInfo[] methodInfos = classFileReader.getMethodInfos();
//    int length = methodInfos.length;
...
//    }
//    assertNotNull(thisEntry);
//    assertEquals("Wrong signature", "Lp/A<TP;>;",
//        new String(thisEntry.getSignature()));
//    ILocalVariableTypeTableEntry tEntry = null;
//    for (int i = 0, max = entries.length; i < max; i++) {
//      ILocalVariableTypeTableEntry entry = entries[i];
...
//    ISignatureAttribute signatureAttribute = (ISignatureAttribute)
//        classFileAttribute;
//    assertEquals("Wrong signature",
//        "<T:Ljava/lang/Object;:Lp/B<-TT;>;>Lp/A<TT;>;",
//        new String(signatureAttribute.getSignature()));
//
//    if (!RunJavac)return;
//
...
//    ISignatureAttribute signatureAttribute = (ISignatureAttribute)
//        classFileAttribute;
//    assertEquals("Wrong signature", "<T:Ljava/lang/Object;:Lp/B;>Lp/A<TT;>;",
//        new String(signatureAttribute.getSignature()));
//
//    if (!RunJavac)return;
//
...
//    assertNotNull("No signature", signature);
//    assertEquals("Wrong signature",
//        "<T:Ljava/lang/Object;:Lp/B;:Lp/C;>Lp/A<TT;>;", new String(signature));
//
//    if (!RunJavac)return;
//
//    // Compare with javac
...
//      assertNotNull("No methods", methods);
//      assertEquals("Wrong size", 3, methods.length);
//      assertEquals("Wrong name", "newInstance",
//          new String(methods[1].getSelector()));
...
//      assertNotNull("No signature", signature);
//      assertEquals("Wrong signature",
//          "(LX<Ljava/lang/String;>.MX<Ljava/lang/Thread;>;)V",
//          new String(signature));
//    } catch (ClassFormatException e) {
//      assertTrue(false);
//    } catch (IOException e) {
...
//      char[] signature = methods[2].getGenericSignature();
//      assertNotNull("No signature", signature);
//      assertEquals("Wrong signature", "(LX$MX<Ljava/lang/Thread;>;)V",
//          new String(signature));
//    } catch (ClassFormatException e) {
//      assertTrue(false);
//    } catch (IOException e) {
...
//      char[] signature = methods[2].getGenericSignature();
//      assertNotNull("No signature", signature);
//      assertEquals("Wrong signature", "(LX<Ljava/lang/String;>.MX;)V",
//          new String(signature));
//    } catch (ClassFormatException e) {
//      assertTrue(false);
//    } catch (IOException e) {
...
//      assertNotNull("No signature", signature);
//      assertEquals("Wrong signature",
//          "<U:Ljava/lang/Object;>(Ljava/util/ArrayList<TU;>;)V",
//          new String(signature));
//    } catch (ClassFormatException e) {
//      assertTrue(false);
//    } catch (IOException e) {
...
//      assertNotNull("No signature", signature);
//      assertEquals("Wrong signature", "Ljava/util/List<LX;>;",
//          new String(signature));
//    } catch (ClassFormatException e) {
//      assertTrue(false);
//    } catch (IOException e) {
...
//      assertNotNull("No signature", signature);
//      assertEquals("Wrong signature",
//          "<T:Ljava/lang/Object;>Ljava/lang/Object;", new String(signature));
//    } catch (ClassFormatException e) {
//      assertTrue(false);
//    } catch (IOException e) {
//      assertTrue(false);
...
//      char[] signature = methods[2].getGenericSignature();
//      assertNotNull("No signature", signature);
//      assertEquals("Wrong signature", "<U:Ljava/lang/Object;>([TU;)V",
//          new String(signature));
//    } catch (ClassFormatException e) {
//      assertTrue(false);
//    } catch (IOException e) {
