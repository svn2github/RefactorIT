...
<profile>
    <audit>
        ...
        <item active="false" id="loose_nested_block" priority="LOW"/>
        ...
        <item active="false" id="equals_hashcode" priority="LOW"/>
        ...
        <item active="false" id="self_assignment" priority="LOW"/>
        ...
        <item active="false" id="static_candidate" priority="LOW"/>
