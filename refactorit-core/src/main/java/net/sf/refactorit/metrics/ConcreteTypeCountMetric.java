...
/**
 * Number of Concrete Types (NOTc) metric.
 */
public class ConcreteTypeCountMetric {

  /** Hidden constructor. */

  private ConcreteTypeCountMetric() {
  }
  ...
  /** Test driver for {@link ConcreteTypeCountMetric}. */
  ...
  public static class TestDriver extends TestCase {
    ...
    public static Test suite() {
      ...
      suite.setName("NOTc metric tests");
    ...
    public void testDefault() {
      ...
      cat.info("Testing NOTc for default package");
    ...
    private void assertTypeCount(String packageName,
      ...
      final int actualCount = ConcreteTypeCountMetric.calculate(pkg);

      assertEquals("NOTc for package \"" + packageName + "\"",
