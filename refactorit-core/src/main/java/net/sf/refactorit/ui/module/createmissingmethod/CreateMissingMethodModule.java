...
public class CreateMissingMethodModule extends AbstractRefactorItModule {
  private static final RefactorItAction[] action
      = {new CreateMissingMethodAction()};

  // Register with ModuleManager
  static {
    ModuleManager.registerModule(new CreateMissingMethodModule());
  }

  private CreateMissingMethodModule() {
  }
