...
<profile>
  <audit>
    ...
    <item id="optimize_for_condition" active="true" priority="LOW"/>	
    ...
    <item id="redundant_throws" active="true" priority="HIGH">
    	<skip include_runtime="false" include_errors="false"/>
    </item>
    ...
    <item id="minimize_access" active="true" priority="NORMAL">
      <skip constructors="false"/>
    </item>
	<item id="single_private_assignment" active="true" priority="LOW"/>
    ...
    <item id="possible_npe" active="true" priority="NORMAL"/>
		<item id="static_accessors" active="true" priority="NORMAL"/>
		<item id="loop_cond_modification" active="true" priority="LOW"/>
		<item id="str_equals_order" active="true" priority="LOW"/>
		<item id="dangerous_iterator" active="true" priority="NORMAL"/>
    <item id="null_parameters" active="true" priority="NORMAL"/>
		
  	<!-- misc -->
    <item id="debug_code" active="true" priority="NORMAL"/>
    <item id="duplicate_strings" active="true" priority="LOW"/>
    <item id="early_declaration" active="true" priority="LOW"/>
