...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    public static final class InputStream extends java.io.FilterInputStream
    {
         ...
         * @since 1.3
         */
        public final int read( byte[] dest, int off, int len ) throws java.io.IOException
        {
            int i;
            int b;
            for( i = 0; i < len; i++ )
    ...
    public static final class OutputStream extends java.io.FilterOutputStream
    {
         ...
         * @since 1.3
         */
        public final void write(int theByte) throws java.io.IOException
        {
            // Encoding suspended?
            if( suspendEncoding )
            {
         ...
         * @since 1.3
         */
        public final void write( byte[] theBytes, int off, int len ) throws java.io.IOException
        {
            // Encoding suspended?
            if( suspendEncoding )
            {
