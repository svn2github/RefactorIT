...
public final class BinLogicalExpression extends BinExpression {
  public BinLogicalExpression(BinExpression leftExpression,
  ...
  public final boolean isSame(BinItem other) {
    ...
    return this.assigmentType == expr.assigmentType
        && isBothNullOrSame(this.leftExpression, expr.leftExpression)
        && isBothNullOrSame(this.rightExpression, expr.rightExpression);
  }
